...
public class LinedTableTest {
    ...
    public void oneRow() throws IOException {
        strip("OneRow.pdf", 0, Color.BLACK, null, 0, true, 2, 1, "data1", "data2", "data2");
    }

    @Test
    public void Coordinates_firstPage() throws IOException {
        strip("AIP/NZANR-Aerodrome_Coordinates.pdf", 0, Color.BLACK, null, 0, false, 6, 19, "ALEXANDRA", "HP", "1753031.00E");
    }

    @Test
    public void Coordinates() throws IOException {
        strip("AIP/NZANR-Aerodrome_Coordinates.pdf", 0, Color.BLACK, Pattern.compile("\\*\\*\\*"), 0, false, 6, 215, "ALEXANDRA", "HP", "1735213.00E");
    }

    @Test
    public void LFZ() throws IOException {
        strip("AIP/1_03_NZANR_Part_71_Low_Flying_Zones_LFZ.pdf", 0, Color.BLACK, null, 0, false,
    ...
    public void QNH() throws IOException {
        strip("AIP/1_14_NZANR_Part_71_QNH_Zones.pdf", 0, Color.BLACK, null, 0, false,
                5, 12, "NZQ185", "WEST COAST AREA QNH ZONE", "");
    }

    @Test
    public void PLA() throws IOException {
        strip("AIP/1_04_NZANR_Part_71_Parachute_Landing_Areas_PLA.pdf", 0, Color.BLACK, null, 0, false,
                3, 16, "NZP114", "HAMILTON AERODROME", "[Organisation or Authority:] Using agency: Skydive Queenstown Ltd (trading as Nzone Skydive), PO Box 554, Queenstown 9348, \nTEL (03) 442 2256");
    }
    ...
    public void GEN_3_7_table1() throws IOException {
        strip("AIP/GEN_3.7.pdf", 0, new Color(223, 223, 223),
                Pattern.compile("Table\\s?GEN\\s?3.7-2"), 1, false, 8,
                259, "ALL AIRCRAFT", "FIS", "Nominal range at 10,000 ft: 80 NM\nNote: Terrain shielding may reduce\nAVBL range. ELEV 110 ft");
    }

    private void strip(String filename, int pageNo, Color hdgColor, Pattern tableEnd, int extraRotation, boolean leadingSpaces, int numColumns,
        ...
        var stripper = new LinedTableStripper(loadPDF(file), extraRotation, true, leadingSpaces, 3);
