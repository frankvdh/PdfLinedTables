...
public class IrregularSinglePageTableTest {
    ...
    public void testExtractTable() throws IOException {
        strip("AIP/NZPH_51.1_52.1.pdf", 2,
                Color.BLACK, Pattern.compile("LIGHTING|FACILITIES|SUPPLEMENTARY|MINIMA|FATO/TLOF|Critical\\s*Obstacles"), 10, 0,
                3, "02\n02", "Gr", "910");
    }

    private void strip(String filename, int pageNo, Color headerColour, Pattern tableEnd, int cols, int extraRotation, int size, String first, String middle, String last) throws IOException {
        LOG.info(filename);
        ...
        try (PDDocument doc = Loader.loadPDF(file)) {
            ...
            ArrayList<String[]> table = stripper.extractTable(headerColour, 0, tableEnd, cols);
